...
const amount = 10;
const apiClient = new Mockaroo.Client({apiKey: "0e9f1540"});
...
async function getUsers() {
    if (!users){
        users = await apiClient.generate({
            count: amount,
            schema: 'Users'
        })
    }
...
async function getCompanies() {
    if (!companies){
        companies = await apiClient.generate({
            count: amount,
            schema: 'Companies'
        })
    }
...
describe('Admin create and delete elements in configuration', () => {
    ...
    it('E41 Como usuario administrador cambio el titulo y lo verifico en la página', async () => {
    ...
    it('E42 Como usuario administrador cambio el titulo por uno de al menos 500 caracteres y lo verifico en la página', async () => {
        const company = await getCompany();
        const profile_name = "title";
        cy.intercept('/ghost/api/admin/settings').as('saveSettings')
    ...
    it('E43 Como usuario administrador crea un elemento del menu en la navegacion principal', async () => {
    ...
    it('E44 Como usuario administrador actualizo la metaadta del sitio asociado a twitter', async () => {
        const company = await getCompany();
    ...
    it('E45 Como usuario administrador crea un elemento del menu en la navegacion principal con un nombre y un correo y debe guardar el enlace "mailto"', async () => {
        const profile_name = "menu_create";
    ...
    it('E46 Como usuario administrador crea un elemento del menú en la navegacion con información muy larga', async () => {
        const profile_name = "menu_create";
        const company = await getCompany();
        cy.intercept('/ghost/api/admin/settings').as('saveSettings')
    ...
    it('E47 Como usuario administrador crea un elemento del menu en la navegacion secundaria', async () => {
    ...
    it('E48 Como usuario administrador crea un elemento del menu en la navegacion secundaria con información muy larga', async () => {
        const profile_name = "menu_secondary_create";
        const company = await getCompany();
        cy.intercept('/ghost/api/admin/settings').as('saveSettings')
    ...
    it('E49 Como usuario administrador crea un elemento del menu en la navegacion secundaria con un nombre y un correo y debe guardar el enlace "mailto"', async () => {
        const profile_name = "menu_secondary_create";
        const user = await getUser()
    ...
    it('E50 Como usuario administrador cambio la meta data de la página web y lo verifico en la página', async () => {
        const company = await getCompany();
        const profile_name = "title";
        const newTitle = company.name
        cy.intercept('/ghost/api/admin/settings').as('saveSettings')
