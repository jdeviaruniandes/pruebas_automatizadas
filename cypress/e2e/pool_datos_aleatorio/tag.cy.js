...
describe("Admin create new post", () => {
  ...
  it("Como usuario administrador creo un Tag con description datos menores a 255", (feature = "tags") => {
  ...
  it("Como usuario administrador edito un tag con description datos menores a 255", (feature = "tags") => {
    const title = faker.name.jobTitle();
    const description = faker.name.jobType();
  ...
  it("Como usuario administrador creo un tag con description con datos numericos y luego se elimina", (feature = "tags") => {
  ...
  it("Como usuario administrador creo un Tag con titulo igual a 192 caracteres", (feature = "tags") => {
  ...
  it("Como usuario administrador creo un Tag con titulo exactamente igual a 191 caracteres", (feature = "tags") => {
  ...
  it("Como usuario administrador creo un Tag con una descripcion de 500 caracteres", (feature = "tags") => {
  ...
  it("Como usuario administrador creo un Tag con un formato de color en Hexadecimal valido", (feature = "tags") => {
    const title = faker.lorem.sentence();
    const description = faker.lorem.paragraph();
  ...
  it("Como usuario administrador creo un Tag con un formato de color en un formato no valido", (feature = "tags") => {
    const title = faker.lorem.sentence();
    const description = faker.lorem.paragraph();
